    ...
    if (projectRoot && !this.orchestrator.isRunning()) {
      ...
      if (fs.existsSync(focusPath)) {
        try {
          ...
          if (parts.length === 0) {
            const summaryLines = ['📊 **Project Status**', '━━━━━━━━━━━━━━━━━━━━━'];
